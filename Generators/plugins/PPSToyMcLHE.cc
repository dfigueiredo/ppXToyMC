...
class PPSToyMcLHE : public edm::one::EDProducer<edm::BeginRunProducer, edm::EndRunProducer>
{

  public:
    PPSToyMcLHE(const edm::ParameterSet &);
    virtual ~PPSToyMcLHE();
...
PPSToyMcLHE::PPSToyMcLHE(const edm::ParameterSet& pset) :
...
void PPSToyMcLHE::beginRunProduce(edm::Run &run, edm::EventSetup const &) {
...
void PPSToyMcLHE::endRunProduce(edm::Run &run, edm::EventSetup const &es) {
  if(writeLHE){
...
void PPSToyMcLHE::produce(edm::Event &e, const edm::EventSetup& es)
{
  ...
  if (!generationOK)
    throw cms::Exception("PPSToyMcLHE") << "Failed to generate event.";
...
//----------------------------------------------------------------------------------------------------
LHERunInfoProduct::Header PPSToyMcLHE::SLHA() {
...
PPSToyMcLHE::~PPSToyMcLHE()
{
}

//----------------------------------------------------------------------------------------------------

DEFINE_FWK_MODULE(PPSToyMcLHE);
